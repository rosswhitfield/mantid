...
template <typename DetidRange, typename TofRange> class ProcessEventsTask {
public:
  ProcessEventsTask(DetidRange *detids, TofRange *tofs, const BankCalibration *calibration,
