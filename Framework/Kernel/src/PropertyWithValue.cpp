...
PROPERTYWITHVALUE_LOGGER(std::vector<std::vector<uint32_t>>)
PROPERTYWITHVALUE_LOGGER(std::vector<std::vector<int64_t>>)
PROPERTYWITHVALUE_LOGGER(std::vector<std::vector<uint64_t>>)
PROPERTYWITHVALUE_LOGGER(std::vector<std::vector<float>>)
PROPERTYWITHVALUE_LOGGER(std::vector<std::vector<double>>)
